'''
Noob implementation of Heirarchical Multi-Modal Exemplar Feature
(HMME_model)

https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7104151&tag=1
'''

import tensorflow as tf 
import math

def hmme_model(X, y, set_tensor, numclass=14951, size=128):
    '''
